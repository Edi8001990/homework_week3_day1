...
INSERT INTO movies (title, year, show_time) VALUES ('Avengers: Infinity War', 2019, '20:00');
UPDATE movies SET show_time = '23:55' WHERE id = 7;



--REMOVE last five records from movies table
DELETE FROM movies WHERE id BETWEEN 16 AND 20;
